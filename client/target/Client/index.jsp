    <!DOCTYPE HTML>
        ...
        <script src="bower_components/jquery.soap/jquery.soap.js"></script>
        ...
        <div class="cart_bg">
        <ul class="cart">
        <i id="basket" class="cart_icon"></i><p class="cart_desc">$1459.50<br><span class="yellow">2 items</span></p>
        <div class='clearfix'></div>
        </ul>
        ...
        <h1>AMA-Zoun</h1>
        <p>Be sure to check our magnificient products</p>
        </div>
        <div class='clearfix'></div>
        </div>
        </article>
        ...
        <div class="col-md-9" style="columns: 3;" id="productsList" ng-controller="productsList">
        <h3 class="m_1">New Products</h3>
        <div class="content_grid" ng-repeat="row in columns">
        <div class="col_1_of_3 span_1_of_3" ng-repeat="item in row">
        ...
        <div class="price">${{ item.price._ }}</div>
        <div class="clearfix"></div>
        </div>
        </div>
        ...
        <!-- modal -->
        <div id="myBasket" class="modal fade" role="dialog" style="display:none;">
            <div class="modal-dialog">
                ...
                <div class="modal-content first-step">
                    ...
                    <div class="modal-body table">
                        ...
                        <br/>Total price : <span class="total-price"></span><br />
                        <input type="submit" class="validate-basket-btn" value="Confirm basket" />
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
                </div>
                <div class="modal-content second-step" style="display:none;">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="modal-body table">
                        <table class="table">
                            <tr>
                                <td>Credit card number : </td><td><input type="text" class="cc_number" /></td>
                            </tr>
                            <tr>
                                <td>Owner : </td><td><input type="text" class="owner" /></td>
                            </tr>
                            <tr>
                                <td>Limit date : </td><td><input type="number" class="limit_month" min="1" max="12"/>/<input type="number" class="limit_year" min="2015" max="2020" /></td>
                            </tr>
                            <tr>
                                <td>Secret code : </td><td><input type="text" class="ccv" maxlength="3" size="3" /></td>
                            </tr>
                        </table>
